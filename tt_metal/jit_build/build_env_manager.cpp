...
void BuildEnvManager::add_build_env(ChipId device_id, uint8_t num_hw_cqs) {
    ...
    device_id_to_build_env_[device_id].build_env.init(build_key, dev_config, rtoptions, device_kernel_defines);
    device_id_to_build_env_[device_id].firmware_build_states =
        create_build_state(device_id_to_build_env_[device_id].build_env, dev_config, true);
    device_id_to_build_env_[device_id].kernel_build_states =
        create_build_state(device_id_to_build_env_[device_id].build_env, dev_config, false);
}
